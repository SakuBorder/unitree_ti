...
class TienKungRoughCfg(LeggedRobotCfg):
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/assert/TienKung_URDF/urdf/humanoid_publish_12dof_wo_c.urdf'
        name = "TienKung"
...
class TienKungRoughCfgPPO(LeggedRobotCfgPPO):
    class policy:
        init_noise_std = 0.8
