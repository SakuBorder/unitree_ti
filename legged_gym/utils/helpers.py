...
def get_args():
    custom_parameters = [
        {"name": "--task", "type": str, "default": "tiv2", "help": "Resume training or start testing from a checkpoint. Overrides config file if provided."},
        {"name": "--resume", "action": "store_true", "default": False,  "help": "Resume training from a checkpoint"},
        {"name": "--experiment_name", "type": str,  "default": "ti-12dof-realpd", "help": "Name of the experiment to run or load. Overrides config file if provided."},
        {"name": "--run_name", "type": str, "default": "tiv2", "help": "Name of the run. Overrides config file if provided."},
        {"name": "--load_run", "type": str,  "default": "Jul24_23-47-29_tiv2", "help": "Name of the run to load when resume=True. If -1: will load the last run. Overrides config file if provided."},
...
class PolicyExporterHIM(torch.nn.Module):
    ...
    def forward(self, obs_history):
        ...
        return self.actor(torch.cat((obs_history[:, -47:], vel, z), dim=1))
