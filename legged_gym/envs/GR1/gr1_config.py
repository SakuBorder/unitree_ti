...
class Gr1RoughCfg(LeggedRobotCfg):
    ...
    class env(LeggedRobotCfg.env):
        num_observations = 41 # 74 47
        num_privileged_obs = 44 # 77 50
        num_actions = 10 # 21 12
    ...
    class asset(LeggedRobotCfg.asset):
        ...
        file = '/home/zzg/code/human01/assert/GR1T2/urdf/GR1T2_simple.urdf'
        name = "Gr1"
        foot_name = "ankle_pitch"
        penalize_contacts_on = ["hip"]
